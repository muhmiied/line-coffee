...
export const OFFICIAL_PRODUCT_CATEGORIES: ProductCategoryConfig[] = [
  ...
  {
    id: 'build-your-espresso',
    slug: 'build-your-espresso',
    name_en: 'Make Your Espresso',
    name_ar: 'اصنع إسبريسو خاصتك',
    description_en: 'Create a single-origin order or custom whole-bean blend.',
    description_ar: 'اختر منشأ واحدًا أو اصنع توليفة حبوب كاملة خاصة بك.',
    image_url: null,
    aliases: ['customize-blend', 'single-origin-beans'],
  },
  {
    id: 'easy-coffee',
    slug: 'easy-coffee',
    ...
    image_url: null,
    aliases: ['nescafe', 'instant-coffee'],
  },
  {
    id: 'coffee-mix',
    slug: 'coffee-mix',
  ...
  },
  {
    ...
    description_en: 'French coffee, flavored coffee, and chunk products.',
    description_ar: 'قهوة فرنسية وقهوة منكهة ومنتجات بقطع فاخرة.',
    image_url: null,
    aliases: ['flavored-coffee', 'french-coffee'],
  },
  {
    id: 'hot-chocolate',
    slug: 'hot-chocolate',
...
export const LAST_RESORT_PRODUCTS: Product[] = [
  ...
  createProduct({
    ...
    nameAr: 'قهوة فرنسية',
    descEn: 'The original French coffee profile inside the Flavor Coffee family: bold, smooth, and dessert-friendly.',
    descAr: 'الطابع الفرنسي الأصلي داخل عائلة القهوة المنكهة: جريء وناعم ومناسب للحلويات.',
    categorySlug: 'flavor-coffee',
    costPerKg: 220,
    image: PRODUCT_IMAGE_LIBRARY.flavor,
    notes: ['French coffee', 'Bold', 'Smooth'],
    featured: true,
  }),
  createProduct({
    id: 'flavor-hazelnut',
